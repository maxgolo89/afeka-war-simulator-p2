...
public class CrudConstants {
    public static final String HIBERNATE_DRIVER_PROPERTY_NAME               = "hibernate.connection.driver_class";
    public static final String HIBERNATE_URL_PROPERTY_NAME                  = "hibernate.connection.url";
